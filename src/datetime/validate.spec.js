...
describe('isValid', () => {
  [
    ...
    { isoString: '2000-123', valid: true, description: 'as 123 months are added to 2000' },
    { isoString: '2000-12-124', valid: true, description: 'as 124 days are added to 2000-12' },

    { isoString: '', valid: false },
    { isoString: 'Invalid Data', valid: false },
    { isoString: '2xxx', valid: false },
  ].forEach(({ isoString, valid, description = '' }) => {
    it(`"${isoString}" is ${valid ? 'valid' : 'invalid'}, ${description}`, () => assertThat(
